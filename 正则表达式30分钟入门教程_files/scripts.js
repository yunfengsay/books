...
function animate() {
	if (t1) {
		...
		t1
			...
			.set(svg_mg, { fill: "#1976D2" })
			.fromTo('.middleground', 0.2, { y: settings.offscreen_y, opacity: 0 }, { y: settings.f1_y, opacity: 1 }, '+=0.1')
			.staggerFromTo('.frame-1 span', 0.1, { opacity: 0 }, { opacity: 1 }, 0.03, '+=0.1')
		if (settings.style == ANIMATION_STYLES.VERTICAL) {
			t1.to('#gd_logo path', 0.2, { opacity: 1 })
		}

		t1
			// .to(svg_mg, 0.3, {fill: "#1976D2" }, "frame3" )
			.to('.middleground', 0.1, { y: 0 }, 'frame3')
			.to('.foreground .frame-1', 0.3, { opacity: 0 }, "frame3")
		// 	.to('.frame-2', 0.3, { opacity: 1 }, "frame2")
		// 	.staggerFromTo('.frame-2 span', 0.1, { opacity: 0}, {opacity: 1}, 0.03, '+=0.1')
		// if (settings.style == ANIMATION_STYLES.VERTICAL) {
		// 	t1.set('#gd_logo path', {opacity: 0}, 'frame2')
		// 	t1.to('#gd_logo path',0.2,{opacity: 1})
		// }

		if (G_AD_SETUP.size === '300x250') {
			t1
				.to(svg_mg, 0.3, { morphSVG: { shape: "#svg_f3" }, fill: "#02C54C" }, "frame3")
		} else if (G_AD_SETUP.size === '970x250') {
			t1
				.to(svg_mg, 0.3, { morphSVG: { shape: "#svg_f3" }, fill: "#02C54C" }, "frame3")
		} else {
			t1.to(svg_mg, 0.3, { morphSVG: { shape: "#svg_f3" }, fill: "#1976D2" }, "frame3")
		}
		...
		t1
			.set('.middleground .overlay svg', { fill: "#02C54C" })
